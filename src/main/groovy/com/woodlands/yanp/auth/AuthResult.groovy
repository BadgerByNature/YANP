...
/**
 * Represents the results of processing an Authentication message, e.g. 'Success', 'Banned', or 'Incorrect Credentials'.
 * These codes are handled by the default client, they are not specific to our implementation
 */
enum AuthResult {
    WOW_SUCCESS(0x00),
    ...
    WOW_FAIL_FAIL_NO_ACCESS(0x0D),
    WOW_SUCCESS_SURVEY(0x0E),
    WOW_FAIL_PARENTAL_CONTROL(0x0F),
    WOW_FAIL_LOCKED_ENFORCED(0x10),
    WOW_FAIL_TRIAL_ENDED(0x11),
    WOW_FAIL_USE_BATTLE_NET(0x12),
